...
public class CifradorImagemColorida256Cores implements AutomatoCelularHandler {
	 ...
	 * @param nucleoRegra
	 */
	public CifradorImagemColorida256Cores(String caminhoImage, String nucleoRegra, int direcao) {
		try {
	 ...
	 * @param nucleoRegra
	 */
	public CifradorImagemColorida256Cores(String caminhoImage, Regra regra, int direcao) {
		try {
