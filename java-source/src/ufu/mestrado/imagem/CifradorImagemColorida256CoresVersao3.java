...
public class CifradorImagemColorida256CoresVersao3 implements AutomatoCelularHandler {
	 ...
	 * @param nucleoRegra
	 */
	public CifradorImagemColorida256CoresVersao3(String caminhoImage, String nucleoRegra, int direcao) {
		try {
	 ...
	 * @param nucleoRegra
	 */
	public CifradorImagemColorida256CoresVersao3(String caminhoImage, Regra regra, int direcao) {
		try {
