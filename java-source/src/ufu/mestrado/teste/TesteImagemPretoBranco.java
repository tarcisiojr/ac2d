...
public class TesteImagemPretoBranco {
	...
	public static void main(String[] args) throws Exception {
		...
		AutomatoCelular automatoCelular = new AutomatoCelular(
				reticulado, 
				Regra.criarAPatirNucleo("", DirecaoCalculo.NORTE));
